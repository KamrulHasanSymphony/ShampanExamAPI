...
namespace ShampanExam.Service.Question
{
    public class QuestionSubjectService
    {
        ...
        {
            QuestionSubjectRepository _repo = new QuestionSubjectRepository();
            ...
            try
            {
                ...
                string[] conditionValue = { questionSubject.Name.Trim() };

                bool exist = _commonRepo.CheckExists("QuestionSubjects", conditionField, conditionValue, conn, transaction);
                ...
                result = await _repo.Insert(questionSubject, conn, transaction);
        ...
        public async Task<ResultVM> Update(QuestionSubjectVM questionSubject)
        {
            ...
            try
            {
                ...
                string[] conditionValue = { questionSubject.Id.ToString(), questionSubject.Name.Trim() };
                ...
                result = await _repo.Update(questionSubject, conn, transaction);
        ...
        public async Task<ResultVM> ReportPreview(string[] conditionalFields, string[] conditionalValues, PeramModel vm = null)
        {
            ...
            try
            {
                ...
                if (result.Status == "Success" && result.DataVM is DataTable dataTable)
                {
                    ...
                    {
                        var ReportType = new DataColumn("ReportType") { DefaultValue = "QuestionSubject" };

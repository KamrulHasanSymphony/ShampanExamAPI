...
namespace ShampanExam.Service.SetUp
{
    public class UserProfileService
    {
        ...
        public async Task<ResultVM> UserListByUserName(string[] conditionalFields, string[] conditionalValues, CommonUser vm = null)
        {
            UserProfileRepository _repo = new UserProfileRepository();
            ResultVM result = new ResultVM { Status = "Fail", Message = "Error", ExMessage = null, Id = "0", DataVM = null };
            ...
            try
            {
                ...
                result = await _repo.UserListByUserName(conditionalFields, conditionalValues, vm, conn, transaction);

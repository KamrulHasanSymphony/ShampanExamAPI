using ShampanTailor.Repository.Common;
using ShampanTailor.Repository.SetUp;
using ShampanTailor.ViewModel.CommonVMs;
using ShampanTailor.ViewModel.KendoCommon;
using ShampanTailor.ViewModel.SetUpVMs;
using ShampanTailor.ViewModel.Utility;
using System.Data;
using System.Data.SqlClient;

namespace ShampanTailor.Service.SetUp
{
    public class CustomerService
    {
        ...
        public async Task<ResultVM> Insert(CustomerVM customer)
        {
            ...
            try
            {
                ...
                string[] conditionField = { "Code", "IsActive" };
                string[] conditionValue = { customer.Code.Trim(),"1" };
        ...
        public async Task<ResultVM> Update(CustomerVM customer)
        {
            ...
            try
            {
                ...
                #region Check Exist Data
                string[] conditionField = { "Id not", "Code", "IsActive" };
                string[] conditionValue = { customer.Id.ToString(), customer.Code.Trim(),"1" };

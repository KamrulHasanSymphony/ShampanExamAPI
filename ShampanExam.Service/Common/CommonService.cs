...
namespace ShampanExam.Service.Common
{
    public class CommonService
    {
        ...
        public async Task<ResultVM> GetChapterList(string[] conditionalFields, string[] conditionalValues, PeramModel vm = null)
        {
            CommonRepository _repo = new CommonRepository();
            ResultVM result = new ResultVM { Status = "Fail", Message = "Error", ExMessage = null, Id = "0", DataVM = null };
            ...
            try
            {
                ...
                result = await _repo.GetChapterList(conditionalFields, conditionalValues, conn, transaction);

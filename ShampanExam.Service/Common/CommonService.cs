...
namespace ShampanExam.Service.Common
{
    public class CommonService
    {
        ...
        public async Task<ResultVM> GetSubjectList(string[] conditionalFields, string[] conditionalValues, PeramModel vm = null)
        {
            CommonRepository _repo = new CommonRepository();
            ResultVM result = new ResultVM { Status = "Fail", Message = "Error", ExMessage = null, Id = "0", DataVM = null };
            ...
            try
            {
                ...
                result = await _repo.GetSubjectList(conditionalFields, conditionalValues, conn, transaction);
        ...
        public async Task<ResultVM> GetQuestionTypeList(string[] conditionalFields, string[] conditionalValues, PeramModel vm = null)
        {
            CommonRepository _repo = new CommonRepository();
            ResultVM result = new ResultVM { Status = "Fail", Message = "Error", ExMessage = null, Id = "0", DataVM = null };
            ...
            try
            {
                ...
                result = await _repo.GetQuestionTypeList(conditionalFields, conditionalValues, conn, transaction);
